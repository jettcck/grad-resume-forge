...
const ALLOWED: Record<RunStatus, ReadonlyArray<RunStatus>> = {
  ...
  EXECUTING_TOOLS: ['EXECUTING_TOOLS', 'VALIDATING', 'CRITIC_REVIEW', 'WAITING_HUMAN_APPROVAL', 'PARTIAL', 'FAILED', 'CANCELLED'],
  VALIDATING: ['EXECUTING_TOOLS', 'CRITIC_REVIEW', 'WAITING_HUMAN_APPROVAL', 'COMPLETED', 'PARTIAL', 'FAILED', 'CANCELLED'],
  CRITIC_REVIEW: ['EXECUTING_TOOLS', 'WAITING_HUMAN_APPROVAL', 'COMPLETED', 'PARTIAL', 'FAILED', 'CANCELLED'],
  WAITING_HUMAN_APPROVAL: ['EXECUTING_TOOLS', 'COMPLETED', 'PARTIAL', 'FAILED', 'CANCELLED'],
  COMPLETED: [],
  PARTIAL: [],
  FAILED: [],
  CANCELLED: []
